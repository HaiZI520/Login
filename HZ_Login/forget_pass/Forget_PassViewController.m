...
@interface Forget_PassViewController ()<UITextFieldDelegate>
{
...
@implementation Forget_PassViewController
...
- (void)layout{
    ...
    [PassBtn setTitle:@"登录" forState:UIControlStateNormal];
